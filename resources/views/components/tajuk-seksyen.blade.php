...
<div class="text-center">
    <span class="mx-auto block h-px w-14 bg-gradient-to-r from-transparent via-merah to-transparent"></span>

    <h2 class="mt-5 text-3xl font-bold tracking-tight text-white sm:text-4xl">{{ $tajuk }}</h2>
