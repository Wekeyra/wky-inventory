...
@section('kandungan')
    <div class="kad">
        <div class="kad-kepala">
            <form method="GET" class="grid w-full gap-2 sm:grid-cols-2 lg:grid-cols-[1fr_1fr_auto]">
            ...
            <table class="jadual">
                ...
                @forelse ($movements as $gerak)
                    <tr>
                        ...
                        <td class="text-right font-medium">{{ $gerak->kuantiti }}</td>
                ...
                @empty
                    <tr><td colspan="8" class="py-10 text-center text-malap">{{ __('wky.stok.tiada_rekod') }}</td></tr>
                @endforelse
                </tbody>
            </table>
        </div>
